  ...
  return (
    ...
    >
      <div className="store-page-content py-16 sm:py-24">
        <p className="store-eyebrow">Stella Colari</p>
        ...
        <div className="mt-12 grid grid-cols-2 gap-3 sm:gap-5 lg:grid-cols-4" aria-hidden="true">
          {Array.from({ length: 4 }).map((_, index) => (
            <div key={index} className="animate-pulse">
              <div className="aspect-[4/5] bg-[#f1f2ef]" />
              <div className="mt-4 h-3 w-3/4 bg-[#e4e5e1]" />
              <div className="mt-2 h-3 w-1/3 bg-[#ecece9]" />
            </div>
          ))}
        </div>
      </div>
