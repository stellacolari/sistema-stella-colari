...
const menuSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Vendas",
        icon: ShoppingBag,
        description: "Histórico e venda manual",
        defaultOpen: false,
        quickAddHref: "/vendas/nova-v2",
        quickAddLabel: "Efetuar venda",
        links: [
          {
            href: "/resumos/vendas",
      ...
      },
      {
        ...
        label: "Compras",
        icon: ShoppingCart,
        description: "Entradas de produtos",
        defaultOpen: false,
        quickAddHref: "/compras/nova-v2",
        quickAddLabel: "Efetuar compra",
        links: [],
      },
      {
        type: "group",
      ...
      },
      {
        ...
        label: "Movimentações",
        icon: BarChart3,
        description: "Entradas, saídas e custos",
      },
    ],
  },
  {
    title: "Catálogo",
    description: "Produtos e regras",
    items: [
      {
        type: "group",
        href: "/produtos",
        label: "Produtos",
        icon: Package,
        description: "Cadastro e edição",
        defaultOpen: false,
        quickAddHref: "/produtos/novo",
        quickAddLabel: "Adicionar produto",
        links: [],
      },
      {
        type: "link",
      ...
      },
      {
        ...
        icon: Boxes,
        description: "Embalagens e insumos",
        defaultOpen: false,
        quickAddHref: "/itens-adicionais/novo",
        quickAddLabel: "Adicionar item adicional",
        links: [],
      },
      {
        type: "link",
        ...
        description: "Consumo de adicionais",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        quickAddLabel: "Adicionar cliente",
        links: [
          {
  ...
  {
    title: "Site",
    description: "Loja pública e editor",
    items: [
      {
        type: "group",
        href: "/site",
        ...
        icon: Store,
        description: "Páginas, banners e formulários",
        defaultOpen: true,
        highlight: true,
        tone: "site",
        links: [
  ...
  {
    title: "Sistema",
    description: "Ajustes e integrações",
    items: [
      {
        type: "link",
        ...
        label: "Integrações",
        icon: PlugZap,
        description: "Canais, gateways e importações",
        tone: "system",
      },
      {
        type: "link",
