...
export default function BlocoPublicoRenderer({
  ...
  if (bloco.tipo === "BANNER_EDITORIAL") {
    return <BannerEditorialPublico bloco={bloco} produtos={produtos} />;
  }
  ...
  if (bloco.tipo === "GALERIA_EDITORIAL_FULL_BLEED") {
    return (
      <GaleriaEditorialFullBleedPublico bloco={bloco} produtos={produtos} />
    );
  }
