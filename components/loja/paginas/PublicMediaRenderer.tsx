...
export default function PublicMediaRenderer({
  ...
  return (
    <div
      className={`flex h-full w-full items-center justify-center bg-[var(--brand-blue-soft)] text-xs font-semibold uppercase tracking-[0.14em] text-black/45 ${className}`}
    >
      {placeholder || null}
    </div>
  );
