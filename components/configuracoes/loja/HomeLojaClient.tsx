...
import { ImageIcon, LayoutGrid, Plus, Save, Trash2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-6 xl:grid-cols-[420px_1fr]">
        <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-500">
            Cadastre até 6 categorias para aparecerem em boxes quadrados na
            home. Agora você pode usar categorias mãe ou subcategorias.
          </p>
      ...
      <section className="grid gap-6 xl:grid-cols-[420px_1fr]">
        <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
          ...
          <div className="mt-5 space-y-4">
            <input
              ...
              placeholder="H2 da seção. Ex: Presentes especiais"
              className="h-11 w-full rounded-2xl border border-slate-200 px-3 text-sm outline-none focus:border-slate-400"
            />
        ...
        <div className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
          ...
          <div className="mt-4 space-y-3">
            {secoes.map((secao) => (
              ...
              >
                <input
                  ...
                  onBlur={(event) =>
                    atualizarSecao(secao, { titulo: event.target.value })
                  }
                  className="h-10 w-full rounded-xl border border-slate-200 px-3 text-sm outline-none focus:border-slate-400"
                />
                ...
                <p className="mt-2 text-xs text-slate-500">
                  Categorias:{" "}
                  {categoriasStringParaArray(secao.categorias).join(", ")}
                </p>
            ...
            {secoes.length === 0 && (
              <p className="text-sm text-slate-500">
                Nenhuma seção personalizada cadastrada.
              </p>
            )}
          </div>
        </div>
      ...
      <section className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-500">
          Este bloco aparece entre as seções de produtos.
        </p>
