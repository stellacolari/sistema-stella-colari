...
> = {
  ...
  AGUARDANDO_PAGAMENTO: {
    ...
    softClass: "bg-amber-100 text-amber-950 ring-amber-300",
  ...
  PAGO: {
    ...
    cardClass: "border-l-emerald-600",
    softClass: "bg-emerald-100 text-emerald-950 ring-emerald-300",
    buttonClass: "border-emerald-700 bg-emerald-700 text-white hover:bg-emerald-800",
  },
  EM_SEPARACAO: {
    badgeClass: "bg-blue-100 text-blue-950 ring-blue-300",
    cardClass: "border-l-blue-600",
    softClass: "bg-blue-100 text-blue-950 ring-blue-300",
  ...
  AGUARDANDO_RETIRADA: {
    ...
    softClass: "bg-sky-100 text-sky-950 ring-sky-300",
    buttonClass: "border-sky-600 bg-sky-600 text-white hover:bg-sky-700",
  },
  SAIU_PARA_ENTREGA: {
    badgeClass: "bg-cyan-100 text-cyan-950 ring-cyan-300",
    cardClass: "border-l-cyan-600",
    softClass: "bg-cyan-100 text-cyan-950 ring-cyan-300",
    buttonClass: "border-cyan-700 bg-cyan-700 text-white hover:bg-cyan-800",
  },
  ENVIADO: {
  ...
  ENTREGUE: {
    badgeClass: "bg-green-100 text-green-950 ring-green-300",
    cardClass: "border-l-green-700",
    softClass: "bg-green-100 text-green-950 ring-green-300",
    buttonClass: "border-green-700 bg-green-700 text-white hover:bg-green-800",
  },
  PROBLEMA_OPERACIONAL: {
    badgeClass: "bg-rose-100 text-rose-950 ring-rose-300",
    cardClass: "border-l-rose-600",
    softClass: "bg-rose-100 text-rose-950 ring-rose-300",
    buttonClass: "border-rose-700 bg-rose-700 text-white hover:bg-rose-800",
  },
  CANCELADO: {
    badgeClass: "bg-slate-800 text-white ring-slate-700",
    cardClass: "border-l-slate-800",
    softClass: "bg-slate-800 text-white ring-slate-700",
    buttonClass: "border-slate-800 bg-slate-900 text-white hover:bg-slate-800",
  },
};
